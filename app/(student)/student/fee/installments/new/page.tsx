import { studentGetFeeInstallmentOptions } from "@/app/data/student/st-get-installment-split-options";
...
export default async function NewInstallmentsPage() {
  const installmentOptions = await studentGetFeeInstallmentOptions();
