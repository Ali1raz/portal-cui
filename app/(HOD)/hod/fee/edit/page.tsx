import { hodGetFeeForEditInstallments } from "@/app/data/hod/get-fee-for-edit-installments";
import { EditInstallmentsForm } from "./_components/edit-installments-form";

export default async function HodFeeEditPage() {
  const fee = await hodGetFeeForEditInstallments();
  ...
  return (
    <div className="flex flex-1 flex-col gap-4 md:gap-6 p-4 sm:p-6">
