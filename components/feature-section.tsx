...
const features = [
  ...
  },
  {
    ...
    className: "sm:col-span-2 md:col-span-3 p-3",
  },
  {
    id: "complaints",
    children: <ComplaintsVisual />,
...
export function FeatureSection() {
  return (
    <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-6 gap-4">
  ...
  return (
    <>
      <div className="relative mx-auto flex size-32 items-center justify-center rounded-full border-4 border-dashed bg-background shadow-xs outline outline-border outline-offset-4">
        ...
        <CustomTimerIcon
          className="size-14 fill-primary/90"
          aria-hidden="true"
        />
      </div>

      <div className="relative mt-8 space-y-1.5 text-center">
        <FeatureTitle>Quick Enrollment</FeatureTitle>
        <FeatureDescription>
          Register and get started with your academic portal in under 2 minutes.
        </FeatureDescription>
      </div>
    </>
  );
  ...
  return (
    <>
      <div className="relative mx-auto flex size-32 items-center justify-center rounded-full border bg-background shadow-xs outline outline-border outline-offset-4">
        <CustomLockIcon className="size-24" aria-hidden="true" />
      ...
      <div className="relative mt-8 space-y-1.5 text-center">
        ...
        <FeatureDescription>
          Secure access control for students, professors, HODs, directors, and
  ...
  return (
    <>
      ...
      <div className="relative z-10 mt-8 space-y-1.5 text-center">
        ...
        <FeatureDescription>
          Monitor student attendance with detailed records, leave requests, and
    ...
    <div className="grid h-full sm:grid-cols-2">
      <div className="relative z-10 space-y-6 py-8 ps-8 pe-2">
        ...
        <div className="space-y-2">
          <FeatureTitle className="text-base">Course Management</FeatureTitle>
          <FeatureDescription>
            Manage subjects, offerings, enrollments, and teaching assignments
            across semesters and departments.
          </FeatureDescription>
        </div>
      </div>
      {/* Dashboard Screen */}
  ...
  return (
    <div className="grid max-h-120 sm:grid-cols-2">
      <div className="space-y-6 pt-8 pb-4 pl-8 sm:pb-8">
        <div className="flex size-12 items-center justify-center rounded-full border bg-card shadow-xs outline outline-border/80 outline-offset-2">
          <GlobeIcon className="size-5 text-primary/80" aria-hidden="true" />
        </div>
        <div className="space-y-2">
          ...
          <FeatureDescription>
            Targeted announcements by department, program, or batch with
            scheduling and priority features.
          </FeatureDescription>
        </div>
      </div>
      <div className="absolute -right-1 -bottom-1 aspect-video max-h-50 rounded-tl-md border bg-card p-1 sm:max-h-42 md:aspect-square md:max-h-50 lg:aspect-16/12">
  ...
  return (
    <>
      <div className="relative mx-auto flex size-32 items-center justify-center rounded-full border bg-background shadow-xs outline outline-border outline-offset-4">
        <div className="absolute inset-0 scale-120 bg-radial from-foreground/15 via-foreground/5 to-transparent blur-xl" />
        <MessageSquareWarningIcon
          className="size-16 text-primary/90"
          aria-hidden="true"
        />
      </div>

      <div className="relative mt-8 space-y-1.5 text-center">
        <FeatureTitle>Complaint Management</FeatureTitle>
        <FeatureDescription>
          Submit, track, and resolve complaints with department-wise routing and
          HOD oversight.
        </FeatureDescription>
      </div>
    </>
