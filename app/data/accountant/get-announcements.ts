...
import type { AccountantAnnouncementsSearchParams } from "@/app/(accountant)/accountant/announcements/announcements-search-params";

const statusValues = new Set(Object.values(AnnouncementStatus));
const typeValues = new Set(Object.values(AnnouncementType));

type AccountantAnnouncementsParams = Pick<
  AccountantAnnouncementsSearchParams,
  | "page"
  | "pageSize"
  | "sortBy"
  | "sortDir"
...
/// Fetch paginated accountant announcements with filters and sorting.
export async function accountantGetAnnouncements({
  page,
  pageSize,
  sortBy,
  sortDir,
...
/// Row type for accountant announcements table.
export type AccountantAnnouncementRow = Awaited<
  ReturnType<typeof accountantGetAnnouncements>
