...
import type { HodLeaveRequestsChartPoint } from "@/app/data/hod/get-hod-dashboard";
...
type HodLeaveRequestsChartClientProps = {
  data: HodLeaveRequestsChartPoint[];
};

export function HodLeaveRequestsChartClient({
  data,
}: HodLeaveRequestsChartClientProps) {
