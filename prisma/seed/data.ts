...
export const SEED_USERS: SeedUser[] = [
  ...
  },
  {
    id: "user-std-se-109",
    name: "Naveed abbass",
    email: "naveed.abbass@example.com",
    role: Role.STUDENT,
    department: Department.SE,
    program: Program.B,
    batch: Batch.FA,
    enrolled: ["CS101", "CS102", "MTH101", "ENG101", "SE101", "SE102"],
  },
  {
    id: "user-std-se-108",
    name: "Zubair azhar",
    email: "zubair.azhar@example.com",
    role: Role.STUDENT,
    department: Department.SE,
    program: Program.B,
    batch: Batch.SP,
  ...
  {
    id: "user-std-math-113",
    name: "Waseem Maitla",
    email: "waseem.maitla@example.com",
    role: Role.STUDENT,
    department: Department.SE,
    program: Program.B,
    batch: Batch.FA,
