...
import type { HodComplaintsChartPoint } from "@/app/data/hod/get-hod-dashboard";
...
type HodComplaintsChartClientProps = {
  data: HodComplaintsChartPoint[];
};

export function HodComplaintsChartClient({
  data,
}: HodComplaintsChartClientProps) {
    ...
    <Card className="pt-0">
      <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
        <div className="grid flex-1 gap-1">
          ...
          <CardDescription>
            Showing {totalComplaints} complaints in the selected period
          </CardDescription>
        </div>
