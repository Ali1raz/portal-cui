...
/// HOD announcements table with filters, sorting, pagination, and DND.
export function HodAnnouncementsTable({
  announcements,
  totalCount,
}: {
...
function DraggableTableHeader({
  ...
  header: Header<HodAnnouncementRow, unknown>;
}) {
  const {
    attributes,
    isDragging,
...
function DragAlongCell({ cell }: { cell: Cell<HodAnnouncementRow, unknown> }) {
